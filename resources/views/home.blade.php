...
@section('content')
    <!--====|| Hero Section Start ||====-->
			<section class="hero">
				...
				<img class="hero__img" src="assets/img/hero.webp" alt="Hero Image" />
				<div class="hero__content">
					...
					<div class="hero__content--mob">
						<div class="hero__content--title">
							<p>Cutting-Edge Telehealth Solutions</p>
						</div>
						<div class="hero__content--title">
							<p>Nationwide expert provider network</p>
						</div>
						<div class="hero__content--title">
							<p>Personalized white-Lebel platform</p>
						</div>
					</div>
				</div>
			</section>
			...
			>
				...
				<div class="2xl:container mx-auto">
					...
					>
						...
						<!-- Single Service Card End -->
						<div
							class="services__card flex justify-center items-center border-none"
						>
							<a href="services.html" class="dml-btn dml-btn__outline"
								>Learn More</a
							>
						</div>
						<!-- Single Service Card End -->
					...
					<div class="flex justify-center mt-8">
						<!-- <a href="who-we-serve.html"
							><img
								...
								alt="Arrow"
						/></a> -->
						<a href="who-we-serve.html" class="dml-btn dml-btn__outline"
							>Read More</a
						>
					</div>
				</div>
			...
			<!--====|| CTA Section Start ||====-->
			<section class="cta lg:pt-[150px] md:pt-[80px] pt-[50px] relative z-10">
				<!--Frame Integration Start-->
				<div>
					<img
				...
				<div class="2xl:container mx-auto text-center">
					...
					<p class="text-lg mt-5"
						...
						operations. </p
					>
					<a href="clinicians.html" class="dml-btn dml-btn__outline mt-10"
						>Learn More</a
					>
				</div>
			</section>
			...
			>
				...
				<div>
					<img
						...
						src="assets/img/frame/blink-2.svg"
						alt="Frame"
					/>
					<img
				...
				<div class="2xl:container mx-auto">
					...
					>
						<div class="why-choose__card">
							<i
								class="icon-idea md:text-[120px] sm:text-[80px] text-[60px]"
							></i>
							<h4 class="font-bold mt-2">Innovation </h4>
							<p class="why-choose__desc mt-2"
						...
						<div class="why-choose__card">
							<i
								class="icon-mobile md:text-[120px] sm:text-[80px] text-[60px]"
							></i>
						...
						<div class="why-choose__card">
							<i
								class="icon-handshake md:text-[120px] sm:text-[80px] text-[60px]"
							></i>
					...
					<div class="flex justify-center mt-8">
						...
						/></a> -->
						<a
							href="why-choose-docmedilink.html"
			...
			>
				...
				<div class="2xl:container mx-auto">
					...
					<div class="accordion">
						<button
							class="question-btn font-bold md:py-7 py-4 w-full flex justify-between items-center text-start"
							data-toggle="answer-1"
						>
							<h3>Continuous Innovation </h3>
							<i
								class="icon-arrow-down accordion__icon rotate-0 inline-block transition-transform duration-300 text-3xl"
							></i>
						</button>
					...
					<div class="accordion">
						...
						<div class="answer hidden lg:pb-7 pb-3" id="answer-2">
							<p class="text-lg"
								>At Docmedilink, compassion is the foundation of our work. We
					...
					<div class="accordion">
						<button
							class="question-btn font-bold md:py-7 py-4 w-full flex justify-between items-cente"
			...
			<section class="faq lg:pt-[150px] md:pt-[80px] pt-[50px] relative z-10">
				...
				<div>
					<img
						class="absolute -z-10 top-0 -right-[100px]"
						src="assets/img/frame/dice-1.svg"
						alt="Frame"
					/>
				</div>
				...
				<div class="2xl:container mx-auto">
					...
					<div class="accordion">
						...
						<div class="answer hidden md:pb-7 pb-3" id="faq-2">
							<p class="text-lg"
								>We offer comprehensive customer support over phone and e-mail
					...
					<div class="accordion">
						...
						>
							<h3
								>3. How can I learn more about a specific software solution?</h3
							>
							<i
								class="icon-arrow-down accordion__icon rotate-0 inline-block transition-transform duration-300 text-3xl"
							></i>
			...
			<section
				class="contact lg:py-[150px] md:py-[80px] py-[50px]"
				id="contact-us"
			>
				<div class="2xl:container mx-auto grid md:grid-cols-2 gird-cols-1">
					<div class="lg:pe-24 md:pe-10 pe-0">
						...
						>
						<p class="text-lg lg:mt-7 mt-3 md:text-start text-center"
		...
		<footer class="footer pb-20">
			<img
				class="footer__img mx-auto lg:block hidden"
